...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" ref={ref} className="py-16 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            ...
            >
              <Card className="bg-card/50 backdrop-blur-lg border border-border/20 rounded-xl overflow-hidden group transition-all duration-300 hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/10 h-full flex flex-col">
